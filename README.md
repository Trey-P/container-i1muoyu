...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i1muoyu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i1muoyu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Trey-P/container-i1muoyu.git
cd container-i1muoyu
```
...
```
docker attach container-i1muoyu
```
